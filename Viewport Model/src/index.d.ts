interface ViewportModelClass {
    readonly Model: Model
    readonly ViewportFrame: ViewportFrame
    readonly Camera: Camera

    readonly _points: {}
	readonly _modelCFrame: CFrame
	readonly _modelSize: Vector3
    readonly _modelRadius: number
...
declare const ViewportModelClass: ViewportModelConstructor;
export = ViewportModelClass;
